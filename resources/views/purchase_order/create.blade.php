    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="ibox">
                ...
                <div class="ibox-body">
                    <form class="form-horizontal" action="{{ route('purchase-orders.store') }}" method="POST">
                            @csrf
                                        ...
                                        <table class="table table-bordered">
                                            ...
                                            <tfoot>
                                                ...
                                                <tr>
                                                    ...
                                                    <th colspan="2"><input class="form-control" type="number" name="service_charge" id="service_charge" value="{{ old('service_charge', 0) }}" min="0"></th>
                                                </tr>
                                                <tr>
                                                    <th colspan="6" class="text-right">
                                                        Others Charge (+) =
                                                    </th>
                                                    <th colspan="2"> <input class="form-control" type="number" name="others_charge"  id="others_charge"  value="{{ old('others_charge', 0) }}" min="0" ></th>
                                                </tr>
                                                <tr>
            ...
            $(document).on('change', '#product_id', function() {
                ...
                if(productName != undefined && !products.includes(product_id)) {
                    ...
                    let tr = "<tr data=\"" + product_id + "\">" +
                        ...
                        " <td><input class=\"form-control tax-percentile\" required type=\"number\" name=\"tax_percentile[]\" step=\"any\" value=\"" + productPercentile + "\" min=\"0\" max=\"100\"></td>" +
