...
@section('title', 'Bondstein || Requsition Create')
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="ibox">
                ...
                <div class="ibox-body">
                    <form class="form-horizontal" action="{{ route('requisitions.store') }}" method="POST">
                            @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-6 row  @error('date') has-error @enderror ">
                                ...
                                <div class="col-sm-8">
                                    <input class="form-control" required type="text" name="date" value="{{ old('date', date('d-m-Y')) }}" placeholder="Enter date" readonly>
                                    @error('date')
                            ...
                            <div class="form-group col-md-6 row  @error('location_id') has-error @enderror">
                                ...
                                <div class="col-sm-8">
                                    <select class="form-control select_item_list" id="location_id">
                                        <option value="">Select location</option>
                                    @foreach ($Locations as $Locaiton)
                                        <option value="{{ $Locaiton->id }}" {{ $Locaiton->id == old('location_id') ? 'selected' : '' }} >{{ $Locaiton->name }}</option>
                                    @endforeach
