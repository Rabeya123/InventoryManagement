                        ...
                        <table class="table table-striped table-bordered table-hover"id="product">
                            <thead>
                                <tr>
                                    ...
                                    <th>Manufacturer</th>
                                    <th>Description</th>
                                    <th class="text-center">Has Unique Identifier</th>
                                    <th class="text-center">Tax(%)</th>
                                    <th class="text-center">Reorder Limit</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">{{ $Product->has_identifier ? "Yes" : 'No'  }}</td>
                                    <td class="text-center">{{ $Product->tax_percentile  }}</td>
                                    <td class="text-center">{{ $Product->reorder_limit  }}</td>
                                    ...
                                    <td class="text-center">
                                    <a href="{{ route('products.edit', $Product->id)}}" class="btn btn-default btn-xs m-r-5" data-toggle="tooltip" data-original-title="Edit"><i class="fa fa-pencil font-14"></i></a>
