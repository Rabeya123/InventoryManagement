...
<div class="page-heading row">
        <div class="col-md-6">  <h1 class="page-title">Create</h1></div>
        <div class="col-md-6"><a class="btn btn-info float-right mt-4" href="{{ route('categories.create') }}" > <i class="fa fa-plus"></i> Create</a></div>
</div>
                        ...
                        <table class="table table-striped table-bordered table-hover"id="category">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                    <a href="{{ route('categories.edit', $Category->id)}}" class="btn btn-default btn-xs m-r-5" data-toggle="tooltip" data-original-title="Edit"><i class="fa fa-pencil font-14"></i></a>
