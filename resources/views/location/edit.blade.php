...
<div class="page-heading row">
    ...
    <div class="col-md-6"><a class="btn btn-default float-right mt-4" href="{{ route('locations.index') }}" > <i class="fa fa-arrow-left"></i> Back</a></div>
</div>
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="ibox">
                ...
                <div class="ibox-body">
                    <form class="form-horizontal" action="{{ route('locations.update', $Location) }}" method="POST">
                            @csrf
                            @method('PUT')
                        <div class="row">
                            ...
                            @include('layouts.ui.radio', [
                                ...
                                'values' => [1, 0],
                                'selected_value' => $Location->is_active,
                                'colsize' => 6
                            ])
